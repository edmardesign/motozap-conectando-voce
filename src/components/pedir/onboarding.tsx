...
const STORAGE_KEY = "boraze.pedir.onboardingSeen.v1";
...
export function PedirOnboarding() {
      ...
      {isLocationStep ? (
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: 15, lineHeight: 1.5, margin: 0, maxWidth: 320 }}>
            Precisamos saber onde você está para mostrar restaurantes próximos e entregar rápido no seu endereço.
          </p>
        </div>
      ) : (
        <img
