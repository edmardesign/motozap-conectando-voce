...
type LojaRow = Database["public"]["Tables"]["food_lojas"]["Row"];
type ProdutoRow = Database["public"]["Tables"]["food_produtos"]["Row"];
type AdicionalRow = Database["public"]["Tables"]["food_adicionais"]["Row"];
