  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <nav className="flex gap-2 overflow-x-auto px-4 py-3 border-b border-white/10">
        ...
        <a href="/adm/excecoes" className="whitespace-nowrap rounded-full px-3 py-1.5 text-sm bg-white/10 text-foreground/80 hover:bg-white/20">
          Autorizações de deslocamento
        </a>
        <a href="/adm/municipios-permitidos" className="whitespace-nowrap rounded-full px-3 py-1.5 text-sm bg-white/10 text-foreground/80 hover:bg-white/20">
