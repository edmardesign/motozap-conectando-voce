...
export function IntergoHubPage() {
  ...
  const atalhos = [
    { label: "Automóvel", Icon: Car, onClick: () => navigate({ to: "/passageiro/mobilidade/automovel", search: { agendar: undefined, data: undefined, hora: undefined } }) },
    { label: "Moto Táxi", Icon: Bike, onClick: () => navigate({ to: "/passageiro/mobilidade/moto", search: { agendar: undefined, data: undefined, hora: undefined } }) },
