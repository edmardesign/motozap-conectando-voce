...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Intergo Logística" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "Intergo Logística — Sua plataforma completa de logística e mobilidade urbana" },
      { name: "description", content: "Plataforma inteligente de logística institucional e mobilidade urbana para cidades modernas." },
      { property: "og:title", content: "Intergo Logística — Sua plataforma completa de logística e mobilidade urbana" },
      { property: "og:description", content: "Plataforma inteligente de logística institucional e mobilidade urbana para cidades modernas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Intergo Logística — Sua plataforma completa de logística e mobilidade urbana" },
      { name: "twitter:description", content: "Plataforma inteligente de logística institucional e mobilidade urbana para cidades modernas." },
